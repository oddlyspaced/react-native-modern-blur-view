...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ModernBlurViewViewProps>();
    _props = defaultProps;
...
{
    const auto &oldViewProps = *std::static_pointer_cast<ModernBlurViewViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<ModernBlurViewViewProps const>(props);
